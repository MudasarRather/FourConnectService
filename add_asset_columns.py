"""Add the Asset Management additive columns to the live DB.

Run standalone:
    & "C:\\Users\\91700\\AppData\\Local\\Programs\\Python\\Python314\\python.exe" add_asset_columns.py
...
if __name__ == "__main__":
    ...
    applied = ensure_asset_columns(engine)
